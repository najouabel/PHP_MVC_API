            ...
            <div class="col-md-8">
              ...
              <form class="infos" v-on:submit.prevent="Signup">
                ...
                <div class="form-group last mb-4">
                  ...
                  <input type="text" class="form-control" id="inputAddress" placeholder="nationality"  required v-model="clientData.nationality" />
                </div>
                <div class="form-group last mb-4">
                  <label for="inputAddress2"></label>
                  <input type="email" class="form-control" id="inputAddress2" placeholder="address"  required v-model="clientData.address" />
                </div>
                <div class="form-group last mb-4">
                  <label for="inputAddres"></label>
                  <select class=" form-control form-select form-select-sm h-25  w-50" id="inputAddres" v-model="clientData.situation" aria-label=".form-select-sm example">
                ...
                <div class="form-group last mb-4">
                  <label for="inputAddre">naissance</label>
                  <input type="date" class="form-control" id="inputAddre"   required v-model="clientData.naissance" />
                </div>
  ...
  methods: {
    async Signup() {
      const response = await fetch(
        "http://localhost/apivisa/back-end/api/User/addUser",
        {
          method: "POST",
          headers: {
